...
@section('main')
    <div class="page-wrapper">
        <div class="page-content">
            <a href="{{ route('add.slot') }}"><button class="btn btn-primary">Add Slot</button></a>
            <div class="card">
                <div class="card-body">
                                        ...
                                        <tbody>
                                            @if ($slots)
                                                ...
                                                <tr role="row" class="even">
                                                    <td class="sorting_1">{{ $slot->id }}</td>
                                                    <td>{{ $slot->date }}</td>
                                                    <td>{{ $slot->initial_time }}</td>
                                                    <td>{{ $slot->End_time }}</td>
                                                    <td><button class="btn btn-primary"
                                                            onclick="Delete({{ $slot->id }})">Delete</button></td>
                                                </tr>
                                            @endforeach
                                            @endif
...
@section('customJs')
    <script>
        function Delete(id) {
            $.ajax({
                url: '{{ route("delete.slot",":id") }}'.replace(':id',id),
