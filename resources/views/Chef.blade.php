...
@section('main')
    <div class="page-wrapper">
        <div class="page-content">
            <a href="{{ route('add.chef') }}"><button class="btn btn-primary">Add Chef</button></a>
            <div class="card">
                <div class="card-body">
                                        ...
                                        <tbody>
                                            @if ($chefs)
                                                ...
                                                <tr role="row" class="even">
                                                    <td class="sorting_1">{{ $chef->id }}</td>
                                                    <td>{{ $chef->name }}</td>
                                                    <td>{{ $chef->profession }}</td>
                                                    <td>{{ $chef->image }}</td> 
                                                    <td><button class="btn btn-primary"
                                                            onclick="Delete({{ $chef->id }})">Delete</button></td>
                                                </tr>
                                            @endforeach
                                            @endif
...
@section('customJs')
    <script>
        function Delete(id) {
            $.ajax({
                url: '{{ route("delete.chef",":id") }}'.replace(':id',id),
